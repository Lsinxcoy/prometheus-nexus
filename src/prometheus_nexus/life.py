...
class Omega:
    ...
    def _nexus_register_all(self) -> None:
        """批量注册全部机制 + 7 管道进 Nexus(零丢失). 装配逻辑外置于 omega.assembly."""
        from prometheus_nexus.omega.assembly import register_all_mechanisms

        register_all_mechanisms(self)
    ...
    def knowledge_utilization_report(self) -> dict:
        """汇总外部知识在 7 管道中的利用情况. 外置于 omega.monitor."""
        from prometheus_nexus.omega.monitor import knowledge_utilization_report as _kur
    ...
    def _compute_fitness(self):
        """Compute system fitness based on multiple quality dimensions. 外置于 omega.maturity."""
        from prometheus_nexus.omega.maturity import compute_fitness as _cf
